            ...
            return function (componentConfig) {
                try {
                    ...
                    return function (replacers) {
                        ...
                        `props.value.${componentConfig.keyProperty}` : "props.value";
                        return {
                            ...replacers,
                            childComponent: `<${childComponentName} key={${keyPropertyString}} index={props.index} value={props.value} />`, // FIXME: Move this into a template file
