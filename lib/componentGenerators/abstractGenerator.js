            ...
            return function (appConfig, overrideComponentConfig) {
                ...
                const componentConfig = {
                    ...appConfig.components[componentName], ...{
                        ...
                        readOnly: appConfig.components[componentName].readOnly || appConfig.components[componentName].value
                ...
                const footer = componentConfig.noFooter ? "" :
                    (componentConfig.bind || componentConfig.value ? templates.connection : templates.export);
                ...
                try {
                    const replacers = {
                        ...defaultReplacers, ...transformers.reduce((currentReplacements, nextTransformer) => {
