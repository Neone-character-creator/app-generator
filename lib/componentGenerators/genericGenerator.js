...
GenericGenerator.defaultFunctionality = [
            ...
            return function (componentConfig) {
                return function (replacers) {
                    const readOnly = componentConfig.readOnly || componentConfig.type !== "button" ||
                        (!componentConfig.bind && (componentConfig.value !== undefined || componentConfig.text !== undefined));
    ...
    },
    {
        ...
        transform: function (appConfig) {
            return function (componentConfig) {
                return function (replacers) {
                    const bindingExpression = componentConfig.bind;
                    return {
                        ...replacers,
    ...
    },
    {
        ...
        transform: function (appConfig) {
            return function (componentConfig) {
                return function (replacers) {
                    const valueExpression = componentConfig.value || componentConfig.text;
                    return {
                        ...replacers,
                        valueExpression: valueExpression ? `"${valueExpression}"` : "undefined"
                    };
                }
            }
        }
