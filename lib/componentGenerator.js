...
const generateTextfieldComponent = require("./componentGenerators/textfieldGenerator");
const generateNumberComponent = require("./componentGenerators/numberGenerator");
const generateButtonComponent = require("./componentGenerators/buttonGenerator");
    ...
    Object.keys(applicationConfiguration.components).forEach(componentIdentifier => {
        ...
        switch (componentType) {
            ...
            case "textfield":
                generated = {
                    path: `components/${formattedComponentIdentifier}.js`.replace(/ /g, "_"),
                    content: generateTextfieldComponent(componentName)(applicationConfiguration)
                };
                break;
            case "number":
                generated = {
                    path: `components/${formattedComponentIdentifier}.js`.replace(/ /g, "_"),
                    content: generateNumberComponent(componentName)(applicationConfiguration)
                };
                break;
            case "button":
                generated = {
                    path: `components/${formattedComponentIdentifier}.js`.replace(/ /g, "_"),
                    content: generateButtonComponent(componentName)(applicationConfiguration)
                };
                break;
            default:
                generated = {
