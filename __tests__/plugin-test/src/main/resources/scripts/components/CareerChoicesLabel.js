...
class careerChoices extends React.Component {
    render(){
...
const valuePropertyExpression = "Career"; // The expression evaluated to determine the value of the component
