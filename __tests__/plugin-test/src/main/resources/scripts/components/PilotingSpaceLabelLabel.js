...
class pilotingSpaceLabel extends React.Component {
    render(){
...
const Component = pilotingSpaceLabel;
...
const valuePropertyExpression = "# 'Piloting - Space'"; // The expression evaluated to determine the value of the component
