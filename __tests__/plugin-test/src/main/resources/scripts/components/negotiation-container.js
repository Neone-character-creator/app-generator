        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="negotiation" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<NegotiationLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<NegotiationCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<NegotiationRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
