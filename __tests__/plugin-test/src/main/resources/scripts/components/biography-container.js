        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="biography" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<NameTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<SpeciesTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<CareerTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<SpecializationsTextfield value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
