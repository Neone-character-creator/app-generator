...
class coordinationLabel extends React.Component {
    render(){
...
const Component = coordinationLabel;
...
const valuePropertyExpression = "# 'Coordination'"; // The expression evaluated to determine the value of the component
