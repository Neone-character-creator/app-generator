...
class skillAdvancementLabel extends React.Component {
    render(){
...
const Component = skillAdvancementLabel;
...
const valuePropertyExpression = "# 'Skills'"; // The expression evaluated to determine the value of the component
