...
class underworldLabel extends React.Component {
    render(){
...
const Component = underworldLabel;
...
const valuePropertyExpression = "# 'Underworld'"; // The expression evaluated to determine the value of the component
