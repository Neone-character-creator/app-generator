...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newArmorDefense",
            hasError: true
        };
    }
...
class newArmorDefense extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="newArmorDefense" label="Defense" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = newArmorDefense;
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedArmor.defense"; // The expression used to bind this component to the state.
