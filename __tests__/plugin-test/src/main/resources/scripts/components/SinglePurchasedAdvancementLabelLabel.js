...
class singlePurchasedAdvancementLabel extends React.Component {
    render(){
...
const Component = singlePurchasedAdvancementLabel;
...
const valuePropertyExpression = "# `${$this.type} Advancement ${$this.value}`"; // The expression evaluated to determine the value of the component
