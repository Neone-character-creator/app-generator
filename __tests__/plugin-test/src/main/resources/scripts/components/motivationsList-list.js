...
const Child = (props) => {
    return (<MotivationTextfield index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.motivations"; // The expression used to determine the value of binding.
