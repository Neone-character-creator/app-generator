...
class gunneryLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Gunnery'"; // The expression evaluated to determine the value of the component
