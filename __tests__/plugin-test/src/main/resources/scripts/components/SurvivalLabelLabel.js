...
class survivalLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Survival'"; // The expression evaluated to determine the value of the component
