...
class outerRimLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Outer Rim'"; // The expression evaluated to determine the value of the component
