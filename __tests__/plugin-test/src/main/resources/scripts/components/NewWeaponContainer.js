...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newWeapon",
            hasError: true
        };
    }
...
class newWeapon extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="newWeapon" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={1}>
<AddWeaponButton value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<NewWeaponNameSelect value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewWeaponSkillTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewWeaponDamageNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewWeaponRangeTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewWeaponCritNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<NewWeaponSpecialTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
