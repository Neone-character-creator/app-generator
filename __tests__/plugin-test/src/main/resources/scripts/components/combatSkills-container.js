        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="combatSkills" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<BrawlContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<GunneryContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<MeleeContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<RangedLightContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<RangedHeavyContainer value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
