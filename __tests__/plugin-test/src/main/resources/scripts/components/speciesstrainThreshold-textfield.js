...
const boundProperty = "# '' + $state.character.species.strainThreshold.characteristic +  '(' + $state.character.characteristics[$state.character.species.strainThreshold.characteristic] + ') + ' +  $state.character.species.strainThreshold.base "; // The expression used to determine the value of binding.
