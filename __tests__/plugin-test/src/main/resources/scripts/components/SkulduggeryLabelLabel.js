...
class skulduggeryLabel extends React.Component {
    render(){
...
const Component = skulduggeryLabel;
...
const valuePropertyExpression = "# 'Skulduggery'"; // The expression evaluated to determine the value of the component
