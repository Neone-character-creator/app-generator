...
const Child = (props) => {
    return (<ObligationItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.obligations"; // The expression used to determine the value of binding.
