...
import ArmorItemContainer from "./ArmorItemContainer";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorList",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<ArmorItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};
...
const Component = armorList;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.armor"; // The expression used to bind this component to the state.
