...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in speciesAbilitiesContainer",
            hasError: true
        };
    }
...
class speciesAbilitiesContainer extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="speciesAbilitiesContainer" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<SpeciesBaseAbilityBrawnTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityAgilityTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityIntellectTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityCunningTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityWillpowerTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityPresenceTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = speciesAbilitiesContainer;
