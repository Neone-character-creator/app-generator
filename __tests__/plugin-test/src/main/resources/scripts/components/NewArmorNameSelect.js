...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newArmorName",
            hasError: true
        };
    }
...
class newArmorName extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="newArmorName-label">Armor</InputLabel>
                    <Select id="newArmorName" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = newArmorName;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedArmor"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $model.armor.values";
