...
class xenologyLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Xenology'"; // The expression evaluated to determine the value of the component
