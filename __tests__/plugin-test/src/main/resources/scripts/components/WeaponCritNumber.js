...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in weaponCrit",
            hasError: true
        };
    }
...
class weaponCrit extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="weaponCrit" label="Crit" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = weaponCrit;
const isBoundComponent = true
const boundPropertyExpression = "$this.criticalRating"; // The expression used to bind this component to the state.
