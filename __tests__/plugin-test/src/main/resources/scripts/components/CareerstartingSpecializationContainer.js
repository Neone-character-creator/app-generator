...
import StartingSpecializationLabel from './StartingSpecializationLabel';
import StartingSpecializationSelectSelect from './StartingSpecializationSelectSelect';
import StartingSpecializationStartingSkillsLabel from './StartingSpecializationStartingSkillsLabel';
import SpecializationStartingSkillChoicesSelect from './SpecializationStartingSkillChoicesSelect';
...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in careerstartingSpecialization",
            hasError: true
        };
    }
...
class careerstartingSpecialization extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="careerstartingSpecialization" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<StartingSpecializationLabel value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<StartingSpecializationSelectSelect value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<StartingSpecializationStartingSkillsLabel value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<SpecializationStartingSkillChoicesSelect value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<StartingSpecializationAvailableTalentsList value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = careerstartingSpecialization;
