...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in pilotingPlanetaryRating",
            hasError: true
        };
    }
...
class pilotingPlanetaryRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="pilotingPlanetaryRating" label="Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = pilotingPlanetaryRating;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.skills.pilotingPlanetary.rank"; // The expression used to bind this component to the state.
