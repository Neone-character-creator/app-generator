        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="education" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<EducationLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<EducationCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<EducationRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
