...
const Child = (props) => {
    return (<OtherItemTextfield index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.otherItems"; // The expression used to determine the value of binding.
