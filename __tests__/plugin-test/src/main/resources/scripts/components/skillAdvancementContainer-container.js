        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="skillAdvancementContainer" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<SkillAdvancementLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<SkillAdvancementSelect value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<SkillSubmitButton value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
