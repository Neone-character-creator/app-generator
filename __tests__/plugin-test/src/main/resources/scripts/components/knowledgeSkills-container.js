        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="knowledgeSkills" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<CoreWorldsContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<EducationContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<LoreContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<OuterRimContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<UnderworldContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<XenologyContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<OtherContainer value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
