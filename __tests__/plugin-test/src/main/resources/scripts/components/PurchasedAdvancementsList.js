...
import SinglePurchasedAdvancementContainer from "./SinglePurchasedAdvancementContainer";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in purchasedAdvancements",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<SinglePurchasedAdvancementContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};

class purchasedAdvancements extends React.Component {
    render() {
...
const Component = purchasedAdvancements;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.advancements"; // The expression used to bind this component to the state.
