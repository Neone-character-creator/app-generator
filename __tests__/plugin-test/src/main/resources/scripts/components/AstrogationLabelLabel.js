...
class astrogationLabel extends React.Component {
    render(){
...
const Component = astrogationLabel;
...
const valuePropertyExpression = "# 'Astrogation'"; // The expression evaluated to determine the value of the component
