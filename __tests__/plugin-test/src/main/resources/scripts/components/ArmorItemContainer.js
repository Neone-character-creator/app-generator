...
import ArmorNameTextfield from './ArmorNameTextfield';
import ArmorDefenseNumber from './ArmorDefenseNumber';
import ArmorSoakNumber from './ArmorSoakNumber';
import ArmorEncumbranceNumber from './ArmorEncumbranceNumber';
import ArmorHardpointsNumber from './ArmorHardpointsNumber';
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorItem",
            hasError: true
        };
    }
    ...
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="armorItem" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<ArmorNameTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<ArmorDefenseNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<ArmorSoakNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<ArmorEncumbranceNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<ArmorHardpointsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
