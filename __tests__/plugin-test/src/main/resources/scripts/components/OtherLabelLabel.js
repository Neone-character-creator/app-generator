...
class otherLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Other'"; // The expression evaluated to determine the value of the component
