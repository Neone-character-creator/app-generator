...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in money",
            hasError: true
        };
    }
...
class money extends React.Component {
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="money" label="Credits" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = money;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.credits"; // The expression used to bind this component to the state.
