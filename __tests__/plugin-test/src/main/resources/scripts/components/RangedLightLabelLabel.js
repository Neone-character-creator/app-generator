...
class rangedLightLabel extends React.Component {
    render(){
...
const Component = rangedLightLabel;
...
const valuePropertyExpression = "# 'Ranged - Light'"; // The expression evaluated to determine the value of the component
