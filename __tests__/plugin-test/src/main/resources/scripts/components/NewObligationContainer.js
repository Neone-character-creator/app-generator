        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="newObligation" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={3}>
<AddObligationButton value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<NewObligationTypeTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<NewObligationDescriptionTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<NewObligationRatingNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
