...
const boundProperty = "# 'Starting Career Skills (choose ' + _.get($state, 'character.species.startingCareerSkillChoices', 0) + ')'"; // The expression used to determine the value of binding.
