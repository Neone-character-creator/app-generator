...
import CareerChoicesLabel from './CareerChoicesLabel';
...
class Component extends React.Component {
    render(){
        return (<div id="Career">
                    <CareerChoicesLabel value={this.props.value} index={this.props.index}/>
<CareerSelectSelect value={this.props.value} index={this.props.index}/>
<CareerstartingSpecializationContainer value={this.props.value} index={this.props.index}/>
                </div>)
    }
