        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="talentAdvancementContainer" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<TalentAdvancementLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<TalentAdvancementSelect value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<TalentSubmitButton value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
