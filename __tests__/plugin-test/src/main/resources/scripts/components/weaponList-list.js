...
const Child = (props) => {
    return (<WeaponItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.weapons"; // The expression used to determine the value of binding.
