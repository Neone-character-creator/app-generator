        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="melee" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<MeleeLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<MeleeCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<MeleeRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
