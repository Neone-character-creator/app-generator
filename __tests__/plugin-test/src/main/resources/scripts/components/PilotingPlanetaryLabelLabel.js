...
class pilotingPlanetaryLabel extends React.Component {
    render(){
...
const Component = pilotingPlanetaryLabel;
...
const valuePropertyExpression = "# 'Piloting - Planetary'"; // The expression evaluated to determine the value of the component
