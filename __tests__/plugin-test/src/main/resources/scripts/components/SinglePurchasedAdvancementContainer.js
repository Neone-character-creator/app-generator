...
import SinglePurchasedAdvancementLabelLabel from './SinglePurchasedAdvancementLabelLabel';
import SinglePurchasedAdvancementRemoveButtonButton from './SinglePurchasedAdvancementRemoveButtonButton';
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in singlePurchasedAdvancement",
            hasError: true
        };
    }
...
class singlePurchasedAdvancement extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="singlePurchasedAdvancement" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={6}>
<SinglePurchasedAdvancementLabelLabel value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={6}>
<SinglePurchasedAdvancementRemoveButtonButton value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = singlePurchasedAdvancement;
