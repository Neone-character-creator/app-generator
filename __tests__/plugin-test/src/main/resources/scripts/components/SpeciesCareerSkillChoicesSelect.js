...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in speciesCareerSkillChoices",
            hasError: true
        };
    }
...
class speciesCareerSkillChoices extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="speciesCareerSkillChoices-label"></InputLabel>
                    <Select id="speciesCareerSkillChoices" autoWidth={true} value={this.props.value} onChange={this.update}
...
const itemTextPath = 'name';
const valueDisplayExpression = undefined;
const Component = speciesCareerSkillChoices;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.character.speciesCareerSkills"; // The expression used to bind this component to the state.
...
const optionsExpression = "# Object.keys($model.skills.prototype.definition).map(d => $model.skills.prototype.definition[d].value.name)";
const action = undefined;
const disabledWhenExpression = undefined;
const hiddenWhenExpression = undefined;
const selectionCountExpression = "# $state.character.species && $state.character.species.startingCareerSkillChoices";
