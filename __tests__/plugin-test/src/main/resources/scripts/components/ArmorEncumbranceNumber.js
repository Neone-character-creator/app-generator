...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorEncumbrance",
            hasError: true
        };
    }
...
class armorEncumbrance extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="armorEncumbrance" label="Encumbrance" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = armorEncumbrance;
const isBoundComponent = true
const boundPropertyExpression = "$this.encumbrance"; // The expression used to bind this component to the state.
