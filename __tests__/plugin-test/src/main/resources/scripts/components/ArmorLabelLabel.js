...
class armorLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Armor'"; // The expression evaluated to determine the value of the component
