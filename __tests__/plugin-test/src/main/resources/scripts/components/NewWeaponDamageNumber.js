...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newWeaponDamage",
            hasError: true
        };
    }
...
class newWeaponDamage extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="newWeaponDamage" label="Damage" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = newWeaponDamage;
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedWeapon.damage"; // The expression used to bind this component to the state.
