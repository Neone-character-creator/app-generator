...
class coreWorldsLabel extends React.Component {
    render(){
...
const Component = coreWorldsLabel;
...
const valuePropertyExpression = "# 'Core Worlds'"; // The expression evaluated to determine the value of the component
