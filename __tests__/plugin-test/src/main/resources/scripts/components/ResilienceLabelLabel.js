...
class resilienceLabel extends React.Component {
    render(){
...
const Component = resilienceLabel;
...
const valuePropertyExpression = "# 'Resilience'"; // The expression evaluated to determine the value of the component
