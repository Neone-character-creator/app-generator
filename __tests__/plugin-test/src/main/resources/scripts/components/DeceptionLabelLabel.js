...
class deceptionLabel extends React.Component {
    render(){
...
const Component = deceptionLabel;
...
const valuePropertyExpression = "# 'Deception'"; // The expression evaluated to determine the value of the component
