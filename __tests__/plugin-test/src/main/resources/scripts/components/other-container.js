        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="other" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<OtherLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<OtherCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<OtherRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
