...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newObligationRating",
            hasError: true
        };
    }
...
class newObligationRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="newObligationRating" label="Obligation Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = newObligationRating;
const isBoundComponent = true
const boundPropertyExpression = "$state.newObligation.rating"; // The expression used to bind this component to the state.
