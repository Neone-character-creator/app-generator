...
class computersLabel extends React.Component {
    render(){
...
const Component = computersLabel;
...
const valuePropertyExpression = "# 'Computers'"; // The expression evaluated to determine the value of the component
