...
import ForceRatingNumber from './ForceRatingNumber';
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in characteristics",
            hasError: true
        };
    }
    ...
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="characteristics" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={3}>
<BrawnCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<AgilityCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<IntellectCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<CunningCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<WillpowerCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<PresenceCharacteristicsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={3}>
<ForceRatingNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = characteristics;
