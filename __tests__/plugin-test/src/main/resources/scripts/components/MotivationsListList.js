...
import MotivationTextfield from "./MotivationTextfield";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in motivationsList",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<MotivationTextfield index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};

class motivationsList extends React.Component {
    render() {
...
const Component = motivationsList;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.motivations"; // The expression used to bind this component to the state.
