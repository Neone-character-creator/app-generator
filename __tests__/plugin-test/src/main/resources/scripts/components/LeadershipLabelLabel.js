...
class leadershipLabel extends React.Component {
    render(){
...
const Component = leadershipLabel;
...
const valuePropertyExpression = "# 'Leadership'"; // The expression evaluated to determine the value of the component
