...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorSoak",
            hasError: true
        };
    }
...
class armorSoak extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="armorSoak" label="Soak" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = armorSoak;
const isBoundComponent = true
const boundPropertyExpression = "$this.soak"; // The expression used to bind this component to the state.
