...
import SpecieswoundsThresholdTextfield from './SpecieswoundsThresholdTextfield';
import SpeciesstrainThresholdTextfield from './SpeciesstrainThresholdTextfield';
import SpeciesStartingExperienceTextfield from './SpeciesStartingExperienceTextfield';
import SpeciesSpecialAbilitiesTextfield from './SpeciesSpecialAbilitiesTextfield';
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in SpeciesProperties",
            hasError: true
        };
    }
...
class SpeciesProperties extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="SpeciesProperties" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<SpecieswoundsThresholdTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<SpeciesstrainThresholdTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<SpeciesStartingExperienceTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<SpeciesSpecialAbilitiesTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = SpeciesProperties;
