...
class vigilanceLabel extends React.Component {
    render(){
...
const Component = vigilanceLabel;
...
const valuePropertyExpression = "# 'Vigilance'"; // The expression evaluated to determine the value of the component
