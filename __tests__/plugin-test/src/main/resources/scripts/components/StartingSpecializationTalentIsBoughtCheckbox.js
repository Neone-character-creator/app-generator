...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in startingSpecializationTalentIsBought",
            hasError: true
        };
    }
...
class startingSpecializationTalentIsBought extends React.Component {
    constructor(props){
        super(props);
    ...
    render() {
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Checkbox id="startingSpecializationTalentIsBought" checked={this.props.value} onChange={this.update} />
            </ErrorBoundary>)
        } else {
            return null
        }
...
const Component = startingSpecializationTalentIsBought;
...
const valuePropertyExpression = "# $state.character.advancements.map(a => a.id).includes($this.id)"; // The expression evaluated to determine the value of the component
