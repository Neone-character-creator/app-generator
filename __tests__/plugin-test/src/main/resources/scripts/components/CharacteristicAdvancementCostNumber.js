...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in characteristicAdvancementCost",
            hasError: true
        };
    }
...
class characteristicAdvancementCost extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="characteristicAdvancementCost" label="Cost" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = characteristicAdvancementCost;
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedAdvancement.characteristic.cost"; // The expression used to bind this component to the state.
