...
class streetwiseLabel extends React.Component {
    render(){
...
const Component = streetwiseLabel;
...
const valuePropertyExpression = "# 'Streetwise'"; // The expression evaluated to determine the value of the component
