        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="skills" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<GeneralSkillsContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<CombatSkillsContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<KnowledgeSkillsContainer value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
