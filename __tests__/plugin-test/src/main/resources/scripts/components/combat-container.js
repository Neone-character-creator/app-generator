        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="combat" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={3}>
<SoakNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={3}>
<WoundsContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={3}>
<StrainContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={3}>
<DefenseContainer value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
