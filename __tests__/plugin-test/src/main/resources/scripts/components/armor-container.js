        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="armor" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<ArmorLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<ArmorListList value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<NewArmorContainer value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
