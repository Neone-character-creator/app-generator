...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in thresholdWounds",
            hasError: true
        };
    }
...
class thresholdWounds extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="thresholdWounds" label="Threshold Wounds" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = thresholdWounds;
...
const valuePropertyExpression = "#  $state.character.wounds"; // The expression evaluated to determine the value of the component
