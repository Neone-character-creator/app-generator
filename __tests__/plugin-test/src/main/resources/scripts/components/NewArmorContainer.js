...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newArmor",
            hasError: true
        };
    }
...
class newArmor extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="newArmor" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={1}>
<AddArmorButton value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<NewArmorNameSelect value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewArmorDefenseNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewArmorSoakNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewArmorEncumbranceNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<NewArmorHardPointsNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
