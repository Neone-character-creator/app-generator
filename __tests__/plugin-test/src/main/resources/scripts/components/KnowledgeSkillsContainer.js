...
import CoreWorldsContainer from './CoreWorldsContainer';
import EducationContainer from './EducationContainer';
import LoreContainer from './LoreContainer';
import OuterRimContainer from './OuterRimContainer';
import UnderworldContainer from './UnderworldContainer';
import XenologyContainer from './XenologyContainer';
...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in knowledgeSkills",
            hasError: true
        };
    }
    ...
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="knowledgeSkills" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<CoreWorldsContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<EducationContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<LoreContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<OuterRimContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<UnderworldContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<XenologyContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={12}>
<OtherContainer value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
...
const Component = knowledgeSkills;
