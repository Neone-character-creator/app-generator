...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in pilotingSpaceRating",
            hasError: true
        };
    }
...
class pilotingSpaceRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="pilotingSpaceRating" label="Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = pilotingSpaceRating;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.skills.pilotingSpace.rank"; // The expression used to bind this component to the state.
