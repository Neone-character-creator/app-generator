...
import OtherItemTextfield from "./OtherItemTextfield";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in otherItems",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<OtherItemTextfield index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};
...
const Component = otherItems;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.otherItems"; // The expression used to bind this component to the state.
