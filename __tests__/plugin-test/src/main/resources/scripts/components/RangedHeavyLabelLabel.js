...
class rangedHeavyLabel extends React.Component {
    render(){
...
const Component = rangedHeavyLabel;
...
const valuePropertyExpression = "# 'Ranged - Heavy'"; // The expression evaluated to determine the value of the component
