...
class talentAdvancementLabel extends React.Component {
    render(){
...
const Component = talentAdvancementLabel;
...
const valuePropertyExpression = "# 'Talents'"; // The expression evaluated to determine the value of the component
