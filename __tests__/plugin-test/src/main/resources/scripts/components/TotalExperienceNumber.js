...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in totalExperience",
            hasError: true
        };
    }
...
class totalExperience extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="totalExperience" label="Total Experience" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = totalExperience;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.totalExperience"; // The expression used to bind this component to the state.
