...
class loreLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Lore'"; // The expression evaluated to determine the value of the component
