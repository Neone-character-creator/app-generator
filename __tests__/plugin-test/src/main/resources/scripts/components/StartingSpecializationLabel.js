...
class startingSpecialization extends React.Component {
    render(){
...
const Component = startingSpecialization;
...
const valuePropertyExpression = "Specialization"; // The expression evaluated to determine the value of the component
