...
import ObligationItemContainer from "./ObligationItemContainer";
...
const Child = (props) => {
    return (<ObligationItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};
...
const boundPropertyExpression = "$state.character.obligations"; // The expression used to bind this component to the state.
