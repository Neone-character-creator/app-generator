...
import WeaponItemContainer from "./WeaponItemContainer";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in weaponList",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<WeaponItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};
...
const Component = weaponList;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.weapons"; // The expression used to bind this component to the state.
