        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="obligations" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<ObligationsLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<NewObligationContainer value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<ObligationsList value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
