...
import StartingSpecializationAvailableTalentsWrapperContainer from "./StartingSpecializationAvailableTalentsWrapperContainer";
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in startingSpecializationAvailableTalents",
            hasError: true
        };
    }
...
const Child = (props) => {
    return (<StartingSpecializationAvailableTalentsWrapperContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} parent={props} />)
};

class startingSpecializationAvailableTalents extends React.Component {
    render() {
...
const Component = startingSpecializationAvailableTalents;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.specializations[0].talents"; // The expression used to bind this component to the state.
