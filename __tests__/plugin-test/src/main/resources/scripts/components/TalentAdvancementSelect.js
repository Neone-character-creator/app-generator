...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in talentAdvancement",
            hasError: true
        };
    }
...
class talentAdvancement extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="talentAdvancement-label"></InputLabel>
                    <Select id="talentAdvancement" autoWidth={true} value={this.props.value} onChange={this.update}
...
const itemTextPath = 'option.value.name';
const valueDisplayExpression = undefined;
const Component = talentAdvancement;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedAdvancement.talent"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $state.availableAdvancements.talent.options.map(o => _.cloneDeep(o)).map(o => {o.option.value = $model.talent.values.find(t => t.id === o.option.value);return o;})";
