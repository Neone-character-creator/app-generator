...
const boundProperty = "# `Specialization Starting Skills (Choose ${_.get($state, 'character.species.startingCareerSkillChoices', 4)})`"; // The expression used to determine the value of binding.
