...
class characteristicAdvancementLabel extends React.Component {
    render(){
...
const Component = characteristicAdvancementLabel;
...
const valuePropertyExpression = "# 'Characteristics'"; // The expression evaluated to determine the value of the component
