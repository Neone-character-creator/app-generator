...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in skillAdvancement",
            hasError: true
        };
    }
...
class skillAdvancement extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="skillAdvancement-label"></InputLabel>
                    <Select id="skillAdvancement" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = skillAdvancement;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedAdvancement.skill"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $state.availableAdvancements.skill.options";
