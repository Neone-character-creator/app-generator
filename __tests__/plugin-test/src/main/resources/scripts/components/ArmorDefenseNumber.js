...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorDefense",
            hasError: true
        };
    }
...
class armorDefense extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="armorDefense" label="Defense" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = armorDefense;
const isBoundComponent = true
const boundPropertyExpression = "$this.defense"; // The expression used to bind this component to the state.
