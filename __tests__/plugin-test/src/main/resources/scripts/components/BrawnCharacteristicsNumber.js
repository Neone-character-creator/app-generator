...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in BrawnCharacteristics",
            hasError: true
        };
    }
...
class BrawnCharacteristics extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="BrawnCharacteristics" label="Brawn" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = BrawnCharacteristics;
...
const valuePropertyExpression = "# $state.character.characteristics.brawn "; // The expression evaluated to determine the value of the component
