...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in IntellectCharacteristics",
            hasError: true
        };
    }
...
class IntellectCharacteristics extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="IntellectCharacteristics" label="Intellect" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = IntellectCharacteristics;
...
const valuePropertyExpression = "# $state.character.characteristics.intellect "; // The expression evaluated to determine the value of the component
