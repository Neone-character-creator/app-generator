...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in skillSubmit",
            hasError: true
        };
    }
...
class skillSubmit extends React.Component {
    constructor (props){
        super(props);
        this.click = function(){
    ...
    render() {
        ...
        return (
            <ErrorBoundary>
        <Button id="skillSubmit" variant="contained" onClick={this.click} disabled={this.props.disabled} >
                    {this.props.value}
                </Button>
                </ErrorBoundary>);
        } else {
...
const action = "# {type:'ADVANCEMENT', advancementType:'skill', advancement: _.get($state, 'selectedAdvancement.skill.option')}";
const disabledWhenExpression = "# _.get($state, 'selectedAdvancement.skill.isAvailable') !== true";
