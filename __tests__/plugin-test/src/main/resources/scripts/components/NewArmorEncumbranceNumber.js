...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newArmorEncumbrance",
            hasError: true
        };
    }
...
class newArmorEncumbrance extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="newArmorEncumbrance" label="Encumbrance" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = newArmorEncumbrance;
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedArmor.encumbrance"; // The expression used to bind this component to the state.
