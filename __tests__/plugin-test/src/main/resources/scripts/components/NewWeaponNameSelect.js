...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newWeaponName",
            hasError: true
        };
    }
...
class newWeaponName extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="newWeaponName-label">Weapon</InputLabel>
                    <Select id="newWeaponName" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = newWeaponName;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedWeapon"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $model.weapon.values";
