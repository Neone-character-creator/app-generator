...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in speciesBaseAbilityPresence",
            hasError: true
        };
    }
...
class Component extends React.Component {
    ...
    render(){
        ...
        return (
        <ErrorBoundary>
        <Textfield disabled={this.props.disabled} id="speciesBaseAbilityPresence" fullWidth={true} label="Presence" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const valuePropertyExpression = "# $state.character.species.baseCharacteristics.presence"; // The expression evaluated to determine the value of the component
