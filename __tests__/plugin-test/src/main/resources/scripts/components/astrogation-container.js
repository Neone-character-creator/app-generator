        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="astrogation" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<AstrogationLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<AstrogationCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<AstrogationRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
