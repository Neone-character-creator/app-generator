...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in careerSelect",
            hasError: true
        };
    }
...
class careerSelect extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="careerSelect-label"></InputLabel>
                    <Select id="careerSelect" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = careerSelect;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.character.career"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $model.career.values";
