...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in pilotingPlanetaryCareerFlag",
            hasError: true
        };
    }
...
class pilotingPlanetaryCareerFlag extends React.Component {
    constructor(props){
        super(props);
    ...
    render() {
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Checkbox id="pilotingPlanetaryCareerFlag" checked={this.props.value} onChange={this.update} />
            </ErrorBoundary>)
        } else {
            return null
        }
...
const Component = pilotingPlanetaryCareerFlag;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.skills.pilotingPlanetary.isCareerSkill"; // The expression used to bind this component to the state.
