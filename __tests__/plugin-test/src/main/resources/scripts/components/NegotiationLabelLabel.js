...
class negotiationLabel extends React.Component {
    render(){
...
const Component = negotiationLabel;
...
const valuePropertyExpression = "# 'Negotiation'"; // The expression evaluated to determine the value of the component
