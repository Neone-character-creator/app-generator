...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in availableExperienceAdvancement",
            hasError: true
        };
    }
...
class Component extends React.Component {
    ...
    render(){
        ...
        return (
        <ErrorBoundary>
        <Textfield disabled={this.props.disabled} id="availableExperienceAdvancement" fullWidth={true} label="Available Experience" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const boundPropertyExpression = "$state.character.availableExperience"; // The expression used to bind this component to the state.
