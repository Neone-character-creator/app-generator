...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in species",
            hasError: true
        };
    }
...
class Component extends React.Component {
    ...
    render(){
        ...
        return (
        <ErrorBoundary>
        <Textfield disabled={this.props.disabled} id="species" fullWidth={true} label="Species" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const valuePropertyExpression = "# $state.character.species.name"; // The expression evaluated to determine the value of the component
