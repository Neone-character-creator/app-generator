        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="speciesAbilitiesContainer" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<SpeciesBaseAbilityBrawnTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityAgilityTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityIntellectTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityCunningTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityWillpowerTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<SpeciesBaseAbilityPresenceTextfield value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
