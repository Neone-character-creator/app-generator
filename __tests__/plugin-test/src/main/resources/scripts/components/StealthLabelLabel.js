...
class stealthLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Stealth'"; // The expression evaluated to determine the value of the component
