...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in speciesSelect",
            hasError: true
        };
    }
...
class speciesSelect extends React.Component {
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="speciesSelect-label">Select Species</InputLabel>
                    <Select id="speciesSelect" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = speciesSelect;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.character.species"; // The expression used to bind this component to the state.
...
const optionsExpression = "# $model.species.values";
