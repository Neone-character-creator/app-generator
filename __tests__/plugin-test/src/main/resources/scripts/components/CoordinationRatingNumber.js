...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in coordinationRating",
            hasError: true
        };
    }
...
class coordinationRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="coordinationRating" label="Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = coordinationRating;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.skills.coordination.rank"; // The expression used to bind this component to the state.
