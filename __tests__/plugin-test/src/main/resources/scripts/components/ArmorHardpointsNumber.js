...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in armorHardpoints",
            hasError: true
        };
    }
...
class armorHardpoints extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="armorHardpoints" label="Hard Points" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = armorHardpoints;
const isBoundComponent = true
const boundPropertyExpression = "$this.hardpoints"; // The expression used to bind this component to the state.
