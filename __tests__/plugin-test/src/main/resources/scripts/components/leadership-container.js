        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="leadership" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<LeadershipLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<LeadershipCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<LeadershipRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
