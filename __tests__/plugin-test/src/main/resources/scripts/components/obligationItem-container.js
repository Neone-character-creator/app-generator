        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="obligationItem" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<ObligationTypeTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<ObligationDescriptionTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<ObligationRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
