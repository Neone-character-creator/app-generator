        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="pilotingSpace" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<PilotingSpaceLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<PilotingSpaceCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<PilotingSpaceRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
