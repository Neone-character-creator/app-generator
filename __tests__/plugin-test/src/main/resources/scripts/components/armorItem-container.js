        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="armorItem" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<ArmorNameTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<ArmorDefenseNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<ArmorSoakNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<ArmorEncumbranceNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<ArmorHardpointsNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
