...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in CunningCharacteristics",
            hasError: true
        };
    }
...
class CunningCharacteristics extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="CunningCharacteristics" label="Cunning" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = CunningCharacteristics;
...
const valuePropertyExpression = "# $state.character.characteristics.cunning "; // The expression evaluated to determine the value of the component
