...
class disciplineLabel extends React.Component {
    render(){
...
const Component = disciplineLabel;
...
const valuePropertyExpression = "# 'Discipline'"; // The expression evaluated to determine the value of the component
