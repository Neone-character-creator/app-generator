...
const valuePropertyExpression = "# 'Starting Career Skills (choose ' + _.get($state, 'character.species.startingCareerSkillChoices', 0) + ')'"; // The expression evaluated to determine the value of the component
