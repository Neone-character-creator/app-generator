...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in speciesstrainThreshold",
            hasError: true
        };
    }
...
class Component extends React.Component {
    ...
    render(){
        ...
        return (
        <ErrorBoundary>
        <Textfield disabled={this.props.disabled} id="speciesstrainThreshold" fullWidth={true} label="Strain Threshold" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const valuePropertyExpression = "# '' + $state.character.species.strainThreshold.characteristic +  '(' + $state.character.characteristics[$state.character.species.strainThreshold.characteristic] + ') + ' +  $state.character.species.strainThreshold.base "; // The expression evaluated to determine the value of the component
