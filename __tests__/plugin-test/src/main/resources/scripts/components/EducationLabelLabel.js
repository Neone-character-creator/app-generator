...
class educationLabel extends React.Component {
    render(){
...
const Component = educationLabel;
...
const valuePropertyExpression = "# 'Education'"; // The expression evaluated to determine the value of the component
