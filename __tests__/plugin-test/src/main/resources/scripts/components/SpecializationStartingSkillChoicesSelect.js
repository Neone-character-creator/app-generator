...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in specializationStartingSkillChoices",
            hasError: true
        };
    }
...
class specializationStartingSkillChoices extends React.Component {
    constructor(props){
        super(props);
    ...
    render(){
        ...
        <FormControl fullWidth={true}>
                    <InputLabel id="specializationStartingSkillChoices-label"></InputLabel>
                    <Select id="specializationStartingSkillChoices" autoWidth={true} value={this.props.value} onChange={this.update}
...
const Component = specializationStartingSkillChoices;
const listItemDisabledExpression = JSON.parse(_.unescape("null"));
const isBoundComponent = true
const boundPropertyExpression = "$state.character.careerStartingSkills"; // The expression used to bind this component to the state.
...
const optionsExpression = "# _.get($state, 'character.career.careerSkills', [])";
