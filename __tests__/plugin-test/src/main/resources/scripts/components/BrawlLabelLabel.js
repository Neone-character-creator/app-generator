...
class brawlLabel extends React.Component {
    render(){
...
const valuePropertyExpression = "# 'Brawl'"; // The expression evaluated to determine the value of the component
