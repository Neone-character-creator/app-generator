...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in weaponDamage",
            hasError: true
        };
    }
...
class weaponDamage extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="weaponDamage" label="Damage" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = weaponDamage;
const isBoundComponent = true
const boundPropertyExpression = "$this.damage"; // The expression used to bind this component to the state.
