...
const Child = (props) => {
    return (<SinglePurchasedAdvancementContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.advancements"; // The expression used to determine the value of binding.
