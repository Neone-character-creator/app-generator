...
const boundProperty = "$state.character.speciesCareerSkills"; // The expression used to determine the value of binding.
const readOnly = false; // If this component only calculates its value, or is bound and can update it.
const valueExpression = "# Object.keys($model.skills.prototype.definition).map(d => $model.skills.prototype.definition[d].value.name)";
