...
class perceptionLabel extends React.Component {
    render(){
...
const Component = perceptionLabel;
...
const valuePropertyExpression = "# 'Perception'"; // The expression evaluated to determine the value of the component
