        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="rangedLight" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={4}>
<RangedLightLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<RangedLightCareerFlagCheckbox value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={4}>
<RangedLightRatingNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
