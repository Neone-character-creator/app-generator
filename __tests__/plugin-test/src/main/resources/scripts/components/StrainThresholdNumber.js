...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in strainThreshold",
            hasError: true
        };
    }
...
class strainThreshold extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="strainThreshold" label="Threshold Strain" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = strainThreshold;
...
const valuePropertyExpression = "#  $state.character.strain"; // The expression evaluated to determine the value of the component
