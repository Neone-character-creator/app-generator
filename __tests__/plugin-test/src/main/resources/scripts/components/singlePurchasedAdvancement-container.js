        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="singlePurchasedAdvancement" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={6}>
<SinglePurchasedAdvancementLabelLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={6}>
<SinglePurchasedAdvancementRemoveButtonButton value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
