...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in mechanicsRating",
            hasError: true
        };
    }
...
class mechanicsRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="mechanicsRating" label="Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = mechanicsRating;
const isBoundComponent = true
const boundPropertyExpression = "$state.character.skills.mechanics.rank"; // The expression used to bind this component to the state.
