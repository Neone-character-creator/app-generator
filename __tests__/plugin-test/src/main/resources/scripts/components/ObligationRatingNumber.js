...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in obligationRating",
            hasError: true
        };
    }
...
class obligationRating extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="obligationRating" label="Obligation Rating" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = obligationRating;
...
const valuePropertyExpression = "# $this.rating"; // The expression evaluated to determine the value of the component
