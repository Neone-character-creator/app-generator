        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="newArmor" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={1}>
<AddArmorButton value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<NewArmorNameSelect value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<NewArmorDefenseNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<NewArmorSoakNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<NewArmorEncumbranceNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<NewArmorHardPointsNumber value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
