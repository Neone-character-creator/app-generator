...
const Child = (props) => {
    return (<StartingSpecializationAvailableTalentsWrapperContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.specializations[0].talents"; // The expression used to determine the value of binding.
