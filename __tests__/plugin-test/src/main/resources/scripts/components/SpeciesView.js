...
import SpeciesCareerSkillChoicesLabel from './SpeciesCareerSkillChoicesLabel';
import SpeciesCareerSkillChoicesSelect from './SpeciesCareerSkillChoicesSelect';
class Component extends React.Component {
    render(){
        return (<div id="Species">
                    <SpeciesSelectSelect value={this.props.value} index={this.props.index}/>
<SpeciesAbilitiesContainerContainer value={this.props.value} index={this.props.index}/>
<SpeciesPropertiesContainer value={this.props.value} index={this.props.index}/>
<SpeciesCareerSkillChoicesLabel value={this.props.value} index={this.props.index}/>
<SpeciesCareerSkillChoicesSelect value={this.props.value} index={this.props.index}/>
                </div>)
    }
