...
class motivationsLabel extends React.Component {
    render(){
...
const Component = motivationsLabel;
...
const valuePropertyExpression = "# 'Motivations'"; // The expression evaluated to determine the value of the component
