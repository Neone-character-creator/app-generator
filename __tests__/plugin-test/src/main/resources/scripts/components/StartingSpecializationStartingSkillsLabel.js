...
class startingSpecializationStartingSkills extends React.Component {
    render(){
...
const Component = startingSpecializationStartingSkills;
...
const valuePropertyExpression = "# `Specialization Starting Skills (Choose ${_.get($state, 'character.species.startingCareerSkillChoices', 4)})`"; // The expression evaluated to determine the value of the component
