        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="careerstartingSpecialization" style={defaultStyle} container spacing={8} justify="space-around" direction={"vertical" == "vertical" ? "column" : "row"}>
                    <Grid item xs={12}>
<StartingSpecializationLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<StartingSpecializationSelectSelect value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<StartingSpecializationStartingSkillsLabel value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<SpecializationStartingSkillChoicesSelect value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={12}>
<StartingSpecializationAvailableTalentsList value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
