...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in WillpowerCharacteristics",
            hasError: true
        };
    }
...
class WillpowerCharacteristics extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="WillpowerCharacteristics" label="Willpower" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = WillpowerCharacteristics;
...
const valuePropertyExpression = "# $state.character.characteristics.willpower "; // The expression evaluated to determine the value of the component
