...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in weaponItem",
            hasError: true
        };
    }
...
class weaponItem extends React.Component {
    render(){
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="weaponItem" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<WeaponNameTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<WeaponSkillTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<WeaponDamageNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<WeaponRangeTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={1}>
<WeaponCritNumber value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
<Grid item xs={2}>
<WeaponSpecialTextfield value={this.props.value} index={this.props.index} parent={this.props}/>
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
