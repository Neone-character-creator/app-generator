        ...
        if(!this.props.hidden){
            return (<ErrorBoundary>
                <Grid id="weaponItem" style={defaultStyle} container spacing={8} justify="space-around" direction={"horizontal" == "vertical" ? "column" : "row"}>
                    <Grid item xs={2}>
<WeaponNameTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<WeaponSkillTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<WeaponDamageNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<WeaponRangeTextfield value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={1}>
<WeaponCritNumber value={this.props.value} index={this.props.index} />
</Grid>
<Grid item xs={2}>
<WeaponSpecialTextfield value={this.props.value} index={this.props.index} />
</Grid>
                </Grid>
            </ErrorBoundary>);
        } else {
