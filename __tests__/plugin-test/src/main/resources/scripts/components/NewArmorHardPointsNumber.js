...
class ErrorBoundary extends React.Component {
    ...
    static getDerivedStateFromError(error){
        return {
            error: "There was an error in newArmorHardPoints",
            hasError: true
        };
    }
...
class newArmorHardPoints extends React.Component {
    constructor(props){
            super(props);
    ...
    render() {
        ...
        return (
        <ErrorBoundary>
            <Textfield id="newArmorHardPoints" label="Hard Points" type="number" value={this.props.value} onChange={this.update} />
        </ErrorBoundary>
        );
        } else {
            return null
...
const Component = newArmorHardPoints;
const isBoundComponent = true
const boundPropertyExpression = "$state.selectedArmor.hardpoints"; // The expression used to bind this component to the state.
