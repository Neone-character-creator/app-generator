...
const Child = (props) => {
    return (<ArmorItemContainer index={props.index} value={props.value} key={props.keyProp} keyProp={props.keyProp} />)
};
...
const boundProperty = "$state.character.armor"; // The expression used to determine the value of binding.
